...
<hr>
	...
	<div class="row awp_bale_offer">
		<div class="">
			...
			<h3><?php esc_html_e( 'Get All Premium Plugin - 20+ Premium Plugins ( Personal Licence) in just $149', 'responsive-slider-gallery' ); ?> </h3>
			...
			<h3><strike><?php esc_html_e( '$399', 'responsive-slider-gallery' ); ?></strike> <?php esc_html_e( '$149 Only', 'responsive-slider-gallery' ); ?></h3>
		</div>
		<div class="">
